...
/** Why prefer zio.Validation over Either? Either short-circuits on failure. If validation errors exist, we just get the first one. You can
  * go for Either[NonEmptyList[String], Unit] but it requires boilerplate
  */
